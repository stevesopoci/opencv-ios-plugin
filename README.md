...
`OpenCViOSPlugin` is an iOS static library written in Objective-C++ that detects and retrieves red laser coordinates via `opencv2.framework`, and it is intended to be used as a native plugin for the Unity project [LaserDetectionUnity](https://github.com/stevesopoci/laser-detection-unity/blob/master/README.md).
...
4. Download and open the [LaserDetectionUnity](https://github.com/stevesopoci/laser-detection-unity/blob/master/README.md) Unity project.
